 ...
 * status bar and navigationSuspend/system bar. This class uses backward-compatibility
...
public abstract class SystemUiHider {
     ...
     * the visibility of the status bar. If there is a navigationSuspend bar, show and
    ...
    /**
     * When this flag is set, {@link #show()} and {@link #hide()} will toggle
     * the visibility of the navigationSuspend bar, if it's present on the device and
     * the device allows hiding it. In cases where the navigationSuspend bar is present
